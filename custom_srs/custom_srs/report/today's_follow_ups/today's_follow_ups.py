...
def get_data(filters):
	...
	if (filters.get('lead')):
		...
		leads = frappe.db.get_all('Lead', filters=lead_filter, fields=['name', 'lead_name', 'lead_owner','status', 'company_name'])
	...
	if (filters.get('quotation')):
		...
		leads = frappe.db.get_all('Quotation', filters=lead_filter, fields=['name', 'customer_name as lead_name', 'lead_owner','status', 'custom_ts_contact_number as contact_number'])
